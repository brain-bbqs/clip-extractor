...
export function getElements() {
  return {
    ...
    dropzoneBusy: required<HTMLDivElement>("dropzoneBusy"),
    dropzoneBusyLabel: required<HTMLSpanElement>("dropzoneBusyLabel"),
    dropzoneBusyDetail: required<HTMLSpanElement>("dropzoneBusyDetail"),
