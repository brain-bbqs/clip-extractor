...
- The transport row now carries that width control on one side of the play buttons and the speed control on the other, each labelled and centred on its own side ([#24](https://github.com/brain-bbqs/clip-extractor/pull/24))
