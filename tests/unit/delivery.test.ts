...
describe("uploadDirectory", () => {
  it("timestamps a directory under the clip-extractor upload root", () => {
    expect(uploadDirectory(new Date("2026-08-09T22:49:13.482Z"))).toBe(`${UPLOAD_ROOT}/2026-08-09T22-49-13Z`);
  });
  ...
  it("gives two uploads a second apart their own directories", () => {
    const a = uploadDirectory(new Date("2026-08-09T22:49:13.000Z"));
    const b = uploadDirectory(new Date("2026-08-09T22:49:14.000Z"));
    expect(a).not.toBe(b);
  });
});
